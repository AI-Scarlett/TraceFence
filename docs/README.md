...
| Document | Purpose |
| --- | --- |
| [Product Overview](product-overview.md) | Positioning, core modules, supported workflows, and the current product map. |
| [Agent Monitoring](agent-monitoring.md) | Local monitoring model, supported data sources, storage policy, and approval workflow. |
